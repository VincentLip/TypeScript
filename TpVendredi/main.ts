import { ImageItem } from "./classes/image";
...
const selectPicture = document.querySelector('#SelectPicture') as HTMLInputElement;
const rightBtn = document.querySelector('#right-btn') as HTMLInputElement;
const leftBtn = document.querySelector('#left-btn') as HTMLInputElement;
let count :number = 0;
...
const refreshSelectPicture = () => {
    ...
    const pictureImage = document.querySelector('img#picture') as HTMLImageElement
    const descriptionImage = document.querySelector('#DescriptionSelect') as HTMLImageElement
